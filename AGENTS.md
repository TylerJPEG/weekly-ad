...
- Do not display a visible numeric zoom percentage. Label the fitted-state action `Reset zoom`, disable it at `Fit` (100%), and enable it whenever the flyer zoom differs from `Fit`.
